 ...
 *
 * <p>Why this exists: model-backed text processing can block longer than the user should wait.
 * This wall is independent of any specific model behaviour: even if some future step blocks, the
 * user's already-seen preview text is committed within the budget.
 *
